...
def get_args(is_train=True):
    ...
    parser.add_argument('--imgH', type=int, default=160, help='the height of the input image')#32
    parser.add_argument('--imgW', type=int, default=400, help='the width of the input image')#100
    parser.add_argument('--rgb', action='store_true', help='use rgb input')
    ch = ' ' + ''.join([chr(i) for i in range(0x4e00,0x4e00+627)])
    parser.add_argument('--character', type=str,
                        default=ch, help='character label')#0123456789abcdefghijklmnopqrstuvwxyz
